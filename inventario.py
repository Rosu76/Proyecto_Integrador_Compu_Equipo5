...
class Inventario(tk.Frame):
    ...
    def widgets(self):
        ...
        self.tre = ttk.Treeview(treFrame, yscrollcommand=scrol_y.set, xscrollcommand=scrol_x.set, height = 40,
                        columnas=("ID", "PRODUCTO", "PROVEEDOR", "PRECIO", "COSTO", "STOCK"), show="headings")
        ...
        self.tre.column("ID", width=70, achor="center")
        self.tre.column("PRODUCTO", width=100, achor="center")
        self.tre.column("PROVEEDOR", width=100, achor="center")
        self.tre.column("PRECIO", width=100, achor="center")
        self.tre.column("COSTO", width=100, achor="center")
        self.tre.column("STOCK", width=70, achor="center")